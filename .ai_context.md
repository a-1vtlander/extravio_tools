...
1. **JSON Configuration System** (`routing/routes.json`)
  ...
  - Format: `{"alias": {"username": "user", "hostroute": "host", "reachable_via_tailscale": true/false, "hosttype": "standard"/"ha"}}`
...
### Network Management
- Automatic Tailscale activation for routes marked `reachable_via_tailscale: true`
...
```json
{
  "alias": {
    ...
    "reachable_via_tailscale": true,
    "hosttype": "standard"
  },
  "ha-primary": {
    "username": "core",
    "hostroute": "homeassistant.local",
    "reachable_via_tailscale": false,
    "hosttype": "ha"
  },
  "dev-container": {
    "username": "user",
